      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/#negocios" className="text-sm text-slate-600 hover:text-slate-900">
              Negocios
            </Link>
              <Link href="/#contacto" className="text-sm text-slate-600 hover:text-slate-900">
             Contacto
            </Link>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden py-4 space-y-2">
            <Link href="/#servicios" onClick={() => setIsOpen(false)} className="block px-4 py-2 text-sm">
              Servicios
            </Link>
            <Link href="/#negocios" onClick={() => setIsOpen(false)} className="block px-4 py-2 text-sm">
              Negocios
            </Link>
            ...
            <div className="px-4 pt-2">
              <a
                href="https://wa.me/5492284656640"
                target="_blank"
                className="flex justify-center items-center gap-2 w-full px-4 py-3 text-sm font-semibold rounded-lg bg-primary text-white"
              >
                <MessageCircle className="w-4 h-4" />
                Contactar
              </a>
