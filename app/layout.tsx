...
export const metadata: Metadata = {
  ...
  title: {
    default: "Desarrollo Web para Negocios | Páginas Web Profesionales",
    template: "%s | ZonaWeb",
  },

  description:
    "Creamos páginas web que representan la identidad de tu negocio. Desde sitios simples hasta sistemas a medida, diseñados para mostrar lo que hacés de forma clara y profesional.",

  applicationName: "ZonaWeb",
  authors: [{ name: "ZonaWeb" }],
  creator: "ZonaWeb",
  publisher: "ZonaWeb",
  category: "technology",
  ...
  openGraph: {
    ...
    description:
      "Creamos páginas web que representan tu negocio en internet. Claras, rápidas y profesionales.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "ZonaWeb - Desarrollo Web",
      },
    ],
  },
  ...
  twitter: {
    card: "summary_large_image",
    title: "ZonaWeb | Desarrollo Web",
    description:
      "Páginas web profesionales para mostrar tu negocio en internet.",
    images: ["/og-image.png"],
  },
